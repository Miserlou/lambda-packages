...
lambda_packages = {
    ...
    'cryptography': {
        'python2.7': {
            'version': '2.14',
            'path': os.path.join(PACKAGES_DIR, 'cryptography', 'python2.7-cryptography-2.1.4.tar.gz')
        },
        'python3.6': {
            'version': '2.1.4',
            'path': os.path.join(PACKAGES_DIR, 'cryptography', 'python3.6-cryptography-2.1.4.tar.gz')
        }
    },
    'cv2': {
        'python2.7': {
